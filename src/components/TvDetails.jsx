...
const TvDetails = () => {
  ...
  return info ? (
    ...
    >
      <div className="w-[90%] mx-auto">
        ...
        <div className="first-part h-screen ">
          <nav className="h-[10vh] w-full text-zinc-100 flex items-center gap-10 text-xl">
            <Link
              onClick={() => navigate(-1)}
              className="hover:text-[#dc1623] mr-2 ri-arrow-left-line"
            ></Link>
        ...
        <div className="middle-part h-screen ">
          ...
          <h1 className="text-3xl mb-10 font-bold text-white">Seasons</h1>
          <div className="w-[100%] mb-10 flex overflow-y-hidden p-5">
            {info.detail.seasons ? (
              info.detail.seasons.map((s, i) => (
                <div key={i} className="w-[15vh] mr-[12%]">
                  <img
                    ...
                    alt=""
                  />
                  <h1 className="text-xl text-zinc-200 mt-3 font-semibold whitespace-nowrap">
                    {s.name}
                  </h1>
                </div>
              ))
      ...
      <div className="last-part h-screen/2 ">
